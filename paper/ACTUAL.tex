...
\multirow{4}{*}{CNO~\cite{Raonic2023}}
  & 100   & \underline{0.014} & 0.047 & 0.055 & 0.058 & \multirow{4}{*}{1.50} \\
...
FNO~\cite{Li2021}
  & all & \textbf{0.009} & \textbf{0.019} & \textbf{0.024} & \textbf{0.027} & 0.61 \\
NeuralPOD-DeepONet~\textit{(ours)}
  & all & \multicolumn{4}{c}{\textit{pend.}} & \textit{pend.} \\
CNO~\cite{Raonic2023}
  & all & 0.012 & 0.023 & 0.027 & 0.030 & 0.90 \\
TEMPO(POD)~\textit{(ours)}
  & $M{=}4$ & 0.097 & 0.144 & 0.155 & 0.170 & \textbf{0.05} \\
TEMPO(NeuralPOD)~\textit{(ours)}
