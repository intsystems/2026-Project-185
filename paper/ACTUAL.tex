...
\multirow{4}{*}{FNO~\cite{Li2021}}
  ...
  & 1.0   & 1.161 & 0.919 & \underline{0.158} \\
\midrule
...
We select $M{=}3$ based on BIC and an entropy elbow: $H$ gains $+0.30$
from $M{=}2$ to $M{=}3$ but only $+0.18$ from $M{=}3$ to $M{=}4$,
indicating the third regime captures genuine structure that a fourth does
not (Table~\ref{tab:regime_selection}, Appendix~\ref{app:exp}).
