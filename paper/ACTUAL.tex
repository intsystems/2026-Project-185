...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.85\textwidth]{TEMPO/main/pictures/npod_phase1.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.8\textwidth]{TEMPO/main/pictures/pod_err_dist.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.8\textwidth]{TEMPO/main/pictures/npod_err_dist.png}
...
Figure~\ref{fig:tempo_phase1_darcy} shows the TEMPO(POD) Phase~1 regime structure on 2D Darcy flow ($M{=}4$ shown for interpretability). Regimes span multiple $\beta$ values. TEMPO(NeuralPOD) discovers a nearly identical partition.
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.75\textwidth]{figs/ns_reconstruction_3d_sample0.png}
