...
def main():
    ...
    if trainer.val_history:
        ...
        ax2 = ax1.twinx()
        ax2.semilogy(ve, vl, color=plt.cm.tab10(1), lw=1.5, ls="--", label="Val rel-L2")
        ax2.set_ylabel("Val rel-L2", color=plt.cm.tab10(1))
        ax2.tick_params(axis="y", labelcolor=plt.cm.tab10(1))
